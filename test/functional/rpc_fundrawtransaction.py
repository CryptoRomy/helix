...
class RawTransactionsTest(HelixTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid helix address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid helix address" in e.error['message'])
