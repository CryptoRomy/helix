...
#ifndef Helix_STAKEINPUT_H
#define Helix_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZHLIX() const = 0;
    virtual CDataStream GetUniqueness() const = 0;
    virtual bool ContextCheck(int nHeight, uint32_t nTime) = 0;
};


class CHlixStake : public CStakeInput
{
private:
...
public:
    ...
    bool IsZHLIX() const override { return false; }
    bool ContextCheck(int nHeight, uint32_t nTime) override;
};


#endif //Helix_STAKEINPUT_H
